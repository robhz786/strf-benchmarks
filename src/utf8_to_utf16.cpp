...
static void bm_strf(benchmark::State& state) {
    ...
    for(auto _ : state) {
        strf::to_range(u16dest)(strf::transcode(u8str));
...
{
    benchmark::RegisterBenchmark("strf::to(u16dest)(strf::transcode(u8small1))", bm_strf<20, 1>);
    benchmark::RegisterBenchmark("strf::to(u16dest)(strf::transcode(u8small2))", bm_strf<20, 2>);
    benchmark::RegisterBenchmark("strf::to(u16dest)(strf::transcode(u8small3))", bm_strf<20, 3>);
    benchmark::RegisterBenchmark("strf::to(u16dest)(strf::transcode(u8small4))", bm_strf<20, 4>);

    benchmark::RegisterBenchmark("    -------------", dummy);

    benchmark::RegisterBenchmark("strf::to(u16dest)(strf::transcode(u8big1))", bm_strf<200, 1>);
    benchmark::RegisterBenchmark("strf::to(u16dest)(strf::transcode(u8big2))", bm_strf<200, 2>);
    benchmark::RegisterBenchmark("strf::to(u16dest)(strf::transcode(u8big3))", bm_strf<200, 3>);
    benchmark::RegisterBenchmark("strf::to(u16dest)(strf::transcode(u8big4))", bm_strf<200, 4>);
